...
Open browser in `http://localhost:3001` and `http://localhost:3001/api/books`. Why can't we access to `http://localhost:3000/api/books`? Because this process is executing itself inside container, we need to expose to our machine:
